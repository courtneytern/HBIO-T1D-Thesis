...
# keep only AA
AFR_AA<- AFRfrq[grepl("AA",AFRfrq$SNP),c("SNP","A1","MAF_A","MAF_U")]
AMR_AA<- AMRfrq[grepl("AA",AMRfrq$SNP),c("SNP","A1","MAF_A","MAF_U")]
EUR_AA<- EURfrq[grepl("AA",EURfrq$SNP),c("SNP","A1","MAF_A","MAF_U")]
...
colnames(mergedAA)<- c("SNP","A1_AFR","AFR_AF_case","AFR_AF_control",
                        "A1_AMR","AMR_AF_case","AMR_AF_control",
                        "A1_EUR","EUR_AF_case","EUR_AF_control")
...
fwrite(mergedAA,"./AA_AF_cc_table.txt")
