...
AFRPlot<- splom(withSexAFR[,3:12], groups=withSexAMR$V3, auto.key=list(space="right"),
                main="AFR Omnibus PC Associations", xlab="PCs 1-10",ylab="PCs 1-10")
...
AMRPlot<- splom(withSexAMR[,3:12], groups=withSexAMR$V3, auto.key=list(space="right"), 
                main="AMR Omnibus PC Associations", xlab="PCs 1-10",ylab="PCs 1-10")

pdf("omnibusPlots_AFR_AMR_bysex.pdf")
  AFRPlot
  AMRPlot
dev.off()
